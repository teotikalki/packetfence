...
In order to configure VLAN enforcement on the Unifi controler, you need first to configure a RADIUS profile, then next a secure and an open Wireless network
...
Complicate isn't it !, Fell free to ask the support directly in the administration interface there: https://community.ubnt.com/t5/UniFi-Wireless/Feature-request-disable-pmksa-caching/m-p/2112479#M257628
